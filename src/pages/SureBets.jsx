  ...
  return (
    <Fragment>
      <Helmet>
        ...
        <title>Sure Bets - Top Free Bets and Arbitrage Opportunities | Watchdogs.net</title>
        <meta name="description" content="Explore sure bets, top free bets, and arbitrage betting opportunities across sports on Watchdogs.net. Find the best odds from various bookmakers." />
        <meta name="keywords" content="sure bets, arbitrage betting, free bets, sports betting, betting opportunities, odds comparison" />
        <meta name="author" content="Watchdogs Team" />
        <link rel="canonical" href="https://watchdogs.net/sure-bets" />
        <link rel="icon" href="/favicon.ico" />
        {/* Open Graph Tags */}
        <meta property="og:title" content="Sure Bets - Top Free Bets and Arbitrage Opportunities | Watchdogs.net" />
        <meta property="og:description" content="Explore sure bets, top free bets, and arbitrage betting opportunities across sports on Watchdogs.net." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://watchdogs.net/sure-bets" />
        <meta property="og:image" content="https://watchdogs.net/og-sure-bets.jpg" />
        <meta property="og:image:alt" content="Sure Bets - Watchdogs.net" />
        <meta property="og:site_name" content="Watchdogs.net" />
        {/* Structured Data: WebPage with ItemList for Sure Bets */}
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Sure Bets",
            "url": "https://watchdogs.net/sure-bets",
            "description": "Sure bets and arbitrage opportunities for sports betting.",
            "publisher": {
              "@type": "Organization",
              "name": "Watchdogs.net",
            ...
            "mainEntity": {
              "@type": "ItemList",
              "name": "Sure Bets",
              "itemListElement": sureBetsData.sections.slice(0, 3).map((section, index) => ({
                "@type": "ListItem",
                "position": index + 1,
                "name": section.title,
                "description": `Sure bets section: ${section.title}`,
                "url": "https://watchdogs.net/sure-bets"
              }))
            }
          })}
