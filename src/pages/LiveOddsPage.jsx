...
// const LiveOddsPage = () => {
//   const [activeSport, setActiveSport] = useState(null); // Default to null to avoid showing data initially
//   const [activeTab, setActiveTab] = useState(null); // Default to null to avoid showing data initially
...
//   // Determine which matches to display based on activeTab and activeSport
//   const getDisplayData = () => {
//     if (!activeSport && !activeTab) {
//       // If no sport or tab is selected, return empty array to show no data
//       return [];
//     }

//     if (activeTab === 'Betting Contest') {
//       // Show betting contest matches (if available)
...
//       // Show only matches with valid odds for the filtered sports
...
//     // Default case: Show all matches for the filtered sports
...
//                           setActiveTab('All Matches'); // Default to 'All Matches' when a sport is selected
//                         }}
...
//                         <span className="font-medium text-gray-900">{league.country || 'Global'}. {league.league}</span>
//                         <span className="text-gray-600">- Matchday {league.matchday || 'N/A'}</span>
//                       </div>
//                       <div className="hidden sm:flex items-center gap-22 text-sm font-medium text-gray-700">
//                         <span>1</span>
//                         <span>X</span>
//                         <span>2</span>
//                       </div>
...
//                             <button className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-3 rounded text-sm font-medium transition-colors duration-200 w-12 text-center">
//                               {match.odds['1']}
//                             </button>
//                             {match.odds.X && (
//                               <button className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-3 rounded text-sm font-medium transition-colors duration-200 w-12 text-center">
...
//                             )}
//                             {!match.odds.X && (
//                               <div className="w-12"></div> // Placeholder to maintain alignment when X is not available
//                             )}
//                             <button className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-3 rounded text-sm font-medium transition-colors duration-200 w-12 text-center">
//                               {match.odds['2']}
//                             </button>
//                           </div>
//                           {/* Mobile Odds Section */}
//                           <div className="flex sm:hidden gap-2 flex-shrink-0">
