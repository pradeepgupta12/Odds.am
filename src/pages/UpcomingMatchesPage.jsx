  ...
  return (
    <Fragment>
      <Helmet>
        ...
        <title>Upcoming Matches - Football, Tennis & More Schedules | Watchdogs.net</title>
        <meta name="description" content="View upcoming matches and fixtures for football, tennis, ice hockey, rugby, cricket, and more sports. Check schedules, odds, and over/under on Watchdogs.net." />
        <meta name="keywords" content="upcoming matches, football fixtures, tennis schedule, ice hockey games, rugby union, cricket matches, sports calendar" />
        <meta name="author" content="Watchdogs Team" />
        <link rel="canonical" href="https://watchdogs.net/upcoming-matches" />
        <link rel="icon" href="/favicon.ico" />
        {/* Open Graph Tags */}
        <meta property="og:title" content="Upcoming Matches - Football, Tennis & More Schedules | Watchdogs.net" />
        <meta property="og:description" content="View upcoming matches and fixtures for football, tennis, ice hockey, rugby, cricket, and more sports on Watchdogs.net." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://watchdogs.net/upcoming-matches" />
        <meta property="og:image" content="https://watchdogs.net/og-upcoming-matches.jpg" />
        <meta property="og:image:alt" content="Upcoming Matches - Watchdogs.net" />
        <meta property="og:site_name" content="Watchdogs.net" />
        {/* Structured Data: WebPage with ItemList for Upcoming Matches */}
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Upcoming Matches",
            "url": "https://watchdogs.net/upcoming-matches",
            "description": "Upcoming sports matches and fixtures across various sports.",
            "publisher": {
              "@type": "Organization",
              "name": "Watchdogs.net",
            ...
            "mainEntity": {
              "@type": "ItemList",
              "name": "Upcoming Matches",
              "itemListElement": Object.values(upcomingMatches).flatMap(league => league.slice(0, 5).map((event, index) => ({
                "@type": "ListItem",
                "position": index + 1,
                "name": `${event.homeTeam?.name || event.player1?.name} vs ${event.awayTeam?.name || event.player2?.name}`,
                "description": `Upcoming match: ${event.league || event.tournament}`,
                "url": "https://watchdogs.net/upcoming-matches"
              })))
            }
          })}
