  ...
  return (
    <Fragment>
      <Helmet>
        ...
        <title>Match Results Archive - Football, Tennis, and More | Watchdogs.net</title>
        <meta name="description" content="View the latest match results and archives for Football, Tennis, Ice Hockey, e-Sports, Baseball, and Basketball on Watchdogs.net. Stay updated with all sports scores." />
        <meta name="keywords" content="match results, football results, tennis results, ice hockey scores, e-sports results, baseball, basketball, sports archive" />
        <meta name="author" content="Watchdogs Team" />
        <link rel="canonical" href="https://watchdogs.net/results" />
        <link rel="icon" href="/favicon.ico" />
        {/* Open Graph Tags */}
        <meta property="og:title" content="Match Results Archive - Football, Tennis, and More | Watchdogs.net" />
        <meta property="og:description" content="View the latest match results and archives for Football, Tennis, Ice Hockey, e-Sports, Baseball, and Basketball on Watchdogs.net." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://watchdogs.net/results" />
        <meta property="og:image" content="https://watchdogs.net/og-results.jpg" />
        <meta property="og:image:alt" content="Match Results - Watchdogs.net" />
        <meta property="og:site_name" content="Watchdogs.net" />
        {/* Structured Data: WebPage with ItemList for Match Results */}
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Match Results Archive",
            "url": "https://watchdogs.net/results",
            "description": "Archive of match results across various sports.",
            "publisher": {
              "@type": "Organization",
              "name": "Watchdogs.net",
            ...
            "mainEntity": {
              "@type": "ItemList",
              "name": "Match Results",
              "itemListElement": Object.values(matchResults.results_data).flat().slice(0, 5).map((competition, index) => ({
                "@type": "ListItem",
                "position": index + 1,
                "name": competition.competition,
                "description": "Match results for " + competition.competition,
                "url": "https://watchdogs.net/results"
              }))
            }
          })}
